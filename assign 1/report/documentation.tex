...
\begin{figure}[H]
	\centering
	\subfloat[$n=500$]{\includegraphics[width=0.5\textwidth]{q2_plot2.png}}
	\subfloat[$n=1000$]{\includegraphics[width=0.5\textwidth]{q2_plot1.png}}\\
	\subfloat[$n=5000$]{\includegraphics[width=0.5\textwidth]{q2_plot3.png}}
	\subfloat[$n=50000$]{\includegraphics[width=0.5\textwidth]{q2_plot4.png}}\\
	\subfloat[$n=500000$]{\includegraphics[width=0.5\textwidth]{q2_plot5.png}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=1.0\textwidth]{q3_graph.png}}
	\caption{2D-plot of $(u_{i-1},u_{i})$ for 1000 random numbers}
\end{figure}

\textbf{\underline{Observations:}}\\
\begin{itemize}
\item Plotted observations are observed to lie on a line.
\item As the number of random numbers generated is increased, the lines get darker.
\item Distance between two lines is very high which implies the random \\numbers generated are not that uniform for given values of a and b. This distance can be decreased by taking better values of a and b.
\end{itemize}
